...
- Build the docker image whose default name is `ros2_kilted_andino_gz`:
...
- Run a docker container from `ros2_kilted_andino_gz` called `ros2_kilted_andino_gz_container`:
