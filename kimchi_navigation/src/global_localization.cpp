...
GlobalLocalizationServer::GlobalLocalizationServer() : Node("global_localization")
{
    ...
    this->action_server_ = rclcpp_action::create_server<GlobalLocalization>(
        this, "global_localization", std::bind(&GlobalLocalizationServer::handleGoal, this, _1, _2),
    ...
    pos_uncertainty_threashold_ = this->get_parameter("position_covariance_threshold").as_double();
    orientation_uncertainty_threashold_ = this->get_parameter("orientation_covariance_threshold").as_double();
    ...
    amcl_pose_subscription_ = this->create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>(
        "/amcl_pose",
        10,
        std::bind(&GlobalLocalizationServer::AmclPoseCallback, this, std::placeholders::_1));
}

rclcpp_action::GoalResponse GlobalLocalizationServer::handleGoal(const rclcpp_action::GoalUUID & uuid, std::shared_ptr<const GlobalLocalization::Goal> goal)
{
...
rclcpp_action::CancelResponse GlobalLocalizationServer::handleCancel(const std::shared_ptr<GoalHandleGlobalLocalization> goal_handle)
{
...
void GlobalLocalizationServer::handleAccepted(const std::shared_ptr<GoalHandleGlobalLocalization> goal_handle)
{
